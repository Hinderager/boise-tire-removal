...
export const metadata: Metadata = {
  ...
  description: 'Professional tire removal and disposal services in Middleton, Idaho. Residential, commercial, and agricultural tire pickup. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-tire-removal.com/cities-served/middleton' },
}
