...
export const metadata: Metadata = {
  title: 'Tire Removal Southeast Boise Boise | Boise Tire Removal',
  description: 'Tire Removal services in Southeast Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['tire removal Southeast Boise', 'tire removal Southeast Boise Boise', 'Southeast Boise boise tire removal'],
  alternates: {
    canonical: 'https://boise-tire-removal.com/cities-served/boise/southeast-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Tire Removal in Southeast Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Southeast Boise with professional tire removal services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Tire Removal in Southeast Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Tire disposal in Southeast Boise is easy when you call us. We pick up and properly recycle old tires.</p>
                <p>
