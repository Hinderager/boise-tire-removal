...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://boise-tire-removal.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Tire Removal in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            North End residents trust us for tire removal. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Tire Removal in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Need old tires removed from your North End property? We properly dispose of tires, keeping them out of local waterways and the Boise River nearby.</p>
                <p>
