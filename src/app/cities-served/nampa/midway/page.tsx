...
export const metadata: Metadata = {
  title: 'Tire Removal Midway Nampa | Boise Tire Removal',
  description: 'Tire Removal services in Midway, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['tire removal Midway', 'tire removal Midway Nampa', 'Midway nampa tire removal'],
  alternates: {
    canonical: 'https://boise-tire-removal.com/cities-served/nampa/midway',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Tire Removal in Midway
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need tire removal services in the Midway area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Tire Removal in Midway, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Tire pickup for Midway properties. Proper disposal.</p>
                <p>
