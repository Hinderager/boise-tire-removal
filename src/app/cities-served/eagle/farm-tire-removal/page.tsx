...
export const metadata: Metadata = {
  ...
  description: 'Professional farm tire removal services in Eagle, Idaho. Fast, reliable tire removal. Call (208) 943-5231.',
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Farm Tire Removal in Eagle</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg text-gray-600">
            <p>Top Shelf Tire Removal provides professional farm tire removal services throughout Eagle and the surrounding Treasure Valley area. We make tire disposal simple and affordable.</p>
