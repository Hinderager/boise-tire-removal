...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://boise-tire-removal.com/cities-served/meridian/lochsa-falls',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Tire Removal in Lochsa Falls
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for tire removal in Lochsa Falls? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Tire Removal in Lochsa Falls, Meridian
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Tire pickup and proper disposal for Lochsa Falls residents. Quick and easy.</p>
                <p>
