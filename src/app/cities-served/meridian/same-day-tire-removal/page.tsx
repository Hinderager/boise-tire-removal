...
export const metadata: Metadata = {
  ...
  description: 'Professional same-day tire removal services in Meridian, Idaho. Fast, reliable tire removal. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-tire-removal.com/cities-served/meridian/same-day-tire-removal' },
}
