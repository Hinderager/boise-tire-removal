...
export const metadata: Metadata = {
  title: 'Terms of Service | Tire Removal Pros',
  description: 'Terms of service for Tire Removal Pros tire removal services in Boise and the Treasure Valley.',
  alternates: {
    canonical: 'https://boise-tire-removal.com/terms',
  },
}
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p>
              Welcome to Tire Removal Pros. By accessing our website or using our services, you agree to be bound by these Terms of Service. Please read them carefully.
            </p>

            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">1. Services</h2>
            <p>
              Tire Removal Pros provides professional tire removal and related services in Boise, Meridian, Nampa, Caldwell, Eagle, and surrounding areas in Idaho. All services are subject to availability and our ability to safely perform the work.
            </p>

            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">2. Service Agreement</h2>
            <p>
              By requesting services from Tire Removal Pros, you represent that you are the property owner or have authorization from the property owner to request and authorize services. You agree to provide accurate information about the property and scope of work needed.
            </p>
            ...
            <ul>
              <li>Tire Removal Pros is fully licensed and insured</li>
            ...
            <p>
              All content on this website, including text, images, logos, and design, is the property of Tire Removal Pros and is protected by copyright and trademark laws. You may not reproduce, distribute, or use our content without written permission.
            </p>
