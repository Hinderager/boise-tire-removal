...
export const metadata: Metadata = {
  title: 'Tire Removal Pros Blog | Tips & Guides for Tire removal',
  description: 'Expert tips, guides, and insights about tire removal in Boise and the Treasure Valley. Learn from the pros at Tire Removal Pros.',
  alternates: {
    canonical: 'https://boise-tire-removal.com/blogs',
  },
}
      ...
      <section className="relative h-[400px] flex items-center">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <p className="text-xl text-white/90 max-w-2xl">
            Tips, guides, and insights about tire removal in the Treasure Valley. Real advice from real professionals.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-dark-blue">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Contact us today for a free estimate on your tire removal project.
          </p>
          <a
            href="tel:2083611982"
