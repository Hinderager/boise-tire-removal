...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy for Tire Removal Pros - how we collect, use, and protect your personal information.',
  alternates: {
    canonical: 'https://boise-tire-removal.com/privacy',
  },
}
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p>
              Tire Removal Pros (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
            </p>
            ...
            <ul>
              ...
              <li>Details about your tire removal needs</li>
            ...
            <ul>
              ...
              <li>Schedule and perform tire removal services</li>
