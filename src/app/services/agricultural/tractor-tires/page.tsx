    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Tractor Tire Removal</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Large tractor tire removal and disposal.</p>
        </div>
      </section>
      <VisibleBreadcrumb />
      <QuickQuoteBar />
